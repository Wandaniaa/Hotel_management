...
urlpatterns = [
    ...
    path('tambah-catatan/', views.tambah_catatan_view, name='tambah_catatan'),
    path('hapus-catatan/<int:catatan_id>/', views.hapus_catatan, name='hapus_catatan'),
    # Booking
    path('booking/', views.booking_list, name='booking_list'),
    path('booking/tambah/', views.tambah_booking, name='tambah_booking'),
    path('booking/edit/<int:pk>/', views.edit_booking, name='edit_booking'),
    path('booking/hapus/<int:pk>/', views.hapus_booking, name='hapus_booking'),
    path('booking/konfirmasi/<int:pk>/', views.konfirmasi_booking, name='konfirmasi_booking'),
    path('booking/batalkan/<int:pk>/', views.batalkan_booking, name='batalkan_booking'),
    path('booking/checkin/<int:pk>/', views.booking_ke_checkin, name='booking_ke_checkin'),
]